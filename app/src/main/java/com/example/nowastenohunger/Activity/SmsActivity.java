...
public class SmsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String phoneNumberOfWhoPosted, messageToBeSent, UID, locationOfWhoPosted, nameOfWhoPosted;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationOfWhoPosted = bu.getString("l");
        nameOfWhoPosted = bu.getString("n");
    ...
    {
        messageToBeSent = messageToBeSent.replace("Has ", "");
        messageToBeSent = messageToBeSent.replace(" left .", "");
        messageToBeSent = nameOfWhoPosted + ", your donation of '" + messageToBeSent + "' will be collected from '" + locationOfWhoPosted + "'.";
